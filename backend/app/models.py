...
class ServerProfile(Base):
    ...
    gpu_json: Mapped[str] = mapped_column(Text, default="{}")
    hardware_json: Mapped[str] = mapped_column(Text, default="{}")
    finetune_env_json: Mapped[str] = mapped_column(Text, default="{}")
...
class FinetuneTask(Base):
    ...
    name: Mapped[str] = mapped_column(String(200))
    model_name: Mapped[str] = mapped_column(String(200), default="")  # deprecated, kept for DB compat
    base_model: Mapped[str] = mapped_column(String(300), default="")  # deprecated, kept for DB compat
    description: Mapped[str] = mapped_column(Text, default="")
...
class FinetuneSubtask(Base):
    ...
    dataset_sync_status: Mapped[str] = mapped_column(Text, default="{}")
    dataset_last_synced_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
    dataset_row_cache: Mapped[str] = mapped_column(Text, default="{}")
    uploaded_files: Mapped[str] = mapped_column(Text, default="[]")
